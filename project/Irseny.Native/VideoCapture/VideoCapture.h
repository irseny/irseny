...
IRSENY_EXPORT IRS_VideoCaptureFrame* irsAllocVideoCaptureFrame(IRS_VideoCapture*);
IRSENY_EXPORT bool irsFreeVideoCaptureFrame(IRS_VideoCapture*, IRS_VideoCaptureFrame*);
IRSENY_EXPORT bool irsCopyVideoFrame(IRS_VideoCaptureFrame*, char*, size_t);
